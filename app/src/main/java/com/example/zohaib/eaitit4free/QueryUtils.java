...
public class QueryUtils {
    ...
    public static String fetchDataForRegistration(String requestUrl,String fname,String lname,
                                                  String mobile,String emaill,
                                                  String pass,String gender)
    {
        ...
        String jsonResponse = null;
        try {
            jsonResponse = makeHttpRequestForRegistration(url,fname,lname,
                    mobile,emaill,
                    pass,gender);
    ...
    private static String makeHttpRequestForRegistration(URL url,String fname,String lname,
                                                         String mobile,String emaill,
                                                         String pass,String gender) throws IOException {
        String jsonResponse = "";
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("confirm password",pass)
